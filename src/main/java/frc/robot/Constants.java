...
public class Constants {
    ...
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = 0.4690872; //track width is left to right distance between the wheels
    public static final double DRIVETRAIN_WHEELBASE_METERS = 0.4690872;  //front to back is the left to right distance between the wheels

...
public class Constants {
    ...
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = 0.4690872; //left to right distance between wheels
    public static final double DRIVETRAIN_WHEELBASE_METERS = 0.4690872; //front to back distance between wheels

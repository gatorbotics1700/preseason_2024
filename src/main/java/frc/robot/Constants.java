...
public class Constants {
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(10.8086 + 180)
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(308.408203125 - 180)
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(196.435546875 - 180)
}

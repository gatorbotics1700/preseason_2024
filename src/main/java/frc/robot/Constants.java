...
public class Constants {
    ...
    //trackwidth is the left to right distance between wheels
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = 0.4690872;
    //wheelbase front to back distance between wheels
    ...
    public static final int FRONT_LEFT_MODULE_STEER_MOTOR = 26;
    public static final int FRONT_LEFT_MODULE_STEER_ENCODER = 5;
    public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 25;
